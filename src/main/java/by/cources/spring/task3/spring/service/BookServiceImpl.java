...
public class BookServiceImpl implements BookService {
    ...
    @Override
    @Transactional
    public List<Author> findAuthorsWithLanguageIs(String value) {
        return authorRepository.findWithLanguageIs(value);
    }

    @Override
    @Transactional
    public List<Author> findAuthorsWithLanguageAndDate(String value, Long year){
        return  authorRepository.findWithLanguageAndDate(value, year);
    }
    ...
    @Override
    @Transactional
    public List<Book> findBooksWithBookLanguage(String value) {
