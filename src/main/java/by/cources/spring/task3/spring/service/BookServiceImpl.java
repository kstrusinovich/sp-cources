...
public class BookServiceImpl implements BookService {
	...
	@Override
	public List<Author> findAuthorsByLang(String value) {
		return authorRepository.findAuthorsByLang(value);
	}

	@Override
	public List<Author> findAuthorsByLangAndYear(String lang, Long year) {
		return authorRepository.findAuthorsByLangAndYear(lang, year);
	}
}
