...
public class BookServiceImpl implements BookService {
  ...
  @Override
  @Transactional
  public List<Language> findLanguagesAll() { return languageRepository.findAll(); }

  @Override
  @Transactional
  public List<Book> findBookByLanguage(String value) {
    return bookRepository.findByLanguage(value);
  }

  @Override
  @Transactional
  public List<Author> findAuthorByLanguage(String value) {
    return authorRepository.findByLanguage(value);
  }

  @Override
  @Transactional
  public List<Author> findAuthorByLanguageOlderThen(String value,Long year) {return authorRepository.findByLanguageOlderThen(value,year);
  }
