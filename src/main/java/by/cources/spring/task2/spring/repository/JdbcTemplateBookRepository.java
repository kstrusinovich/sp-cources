...
import by.cources.spring.task2.spring.repository.mapping.AuthorIdMapper;
...
public class JdbcTemplateBookRepository implements BookRepository 
{
	...
	{
		return jdbcTemplate.query("select distinct author_id from book where year > ?", new Object[]{year}, new AuthorIdMapper());		
	}
