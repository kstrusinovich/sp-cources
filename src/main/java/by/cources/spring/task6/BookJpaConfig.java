...
//    vendorAdapter.setGenerateDdl(true);
  ...
  private Properties getProperties() {
    ...
    jpaProperties.put("javax.persistence.schema-generation.create-script-source", "/task7/create.sql");
...
//    jpaProperties.put("javax.persistence.schema-generation.drop-script-source", "drop.sql");
    jpaProperties.put("javax.persistence.schema-generation.drop-source", "script");
    jpaProperties.put("javax.persistence.sql-load-script-source", "/task7/data.sql");
